#!/bin/bash
# Non-interactive version for Claude Code Routines / cloud execution.
# Usage: ./legible_deep_research_loop_noninteractive.sh "topic" [max_iterations] [model]
#   model: "opus" (default) or "sonnet"
#
# Examples:
#   ./legible_deep_research_loop_noninteractive.sh "AMR pull mechanism CEA" 12
#   ./legible_deep_research_loop_noninteractive.sh "Snakebite gaiters CEA" 10 sonnet
